const CACHE_NAME = 'travel-hub-v28';
const STATIC_CACHE = 'travel-hub-static-v28';
const MEDIA_CACHE = 'travel-hub-media-v5';
const DYNAMIC_CACHE = 'travel-hub-dynamic-v5';

const log = (msg, data = '') => console.log(`[SW v28] ${msg}`, data);
...
<body>
    <div class="container">
        <div class="indicator">OFFLINE-MODUS (v28)</div>
