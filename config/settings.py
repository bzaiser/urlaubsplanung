...
MEDIA_URL = 'media/'
MEDIA_ROOT = env('MEDIA_ROOT', default=os.path.join(BASE_DIR, 'data/media'))
...
PWA_SERVICE_WORKER_PATH = os.path.join(BASE_DIR, 'static/js/sw_v31.js')
PWA_SERVICE_WORKER_AUTO_REGISTER = False
...
CACHES = {
    'default': {
        ...
        'OPTIONS': {
            'MAX_ENTRIES': 1000  # More capacity for many trips/views
        }
    }
}
