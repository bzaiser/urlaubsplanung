...
def get_itinerary_prompt(preferences, start_date, days, start_location, persons_count, persons_ages, user=None):
    ...
    system_text += (
        ...
        "12. LOGISTIK: Bei JEDEM Transport-Event MUSS ein Feld 'distance_km' (als Zahl) und 'end_time' (Ankunftszeit als HH:MM) vorhanden sein. Schätze die Reisezeit REALISTISCH ein (z.B. PKW/Wohnmobil Durchschnitt 60-80 km/h inkl. Pausen).\n"
        ...
        "23. REALISMUS: Schätze Entfernungen ('distance_km') zwischen Orten REALISTISCH ein. Nutze dein Wissen über reale Straßenverbindungen. Keine 0 km bei Fahrten zwischen verschiedenen Städten!\n"
        "24. KOSTEN: Schätze für JEDES Event (Eintritt, Hotelnacht, Campingplatz-Gebühr, Parkplatz, Fähre) die Kosten REALISTISCH ein und gib sie im Feld 'cost_estimated' (als Zahl) an.\n"
        "25. TRANSPORT-TYPEN: Nutze für die Klassifizierung (Feld 'type') folgende Tabelle für lokale Begriffe:\n"
