...
def get_itinerary_prompt(preferences, start_date, days, start_location, persons_count, persons_ages, user=None):
    ...
    system_text += (
        ...
        "16. HIERARCHIE: Gruppiere die Reise in logische 'stations' (Stopps/Aufenthalte). Eine Station (z.B. 'Sizilien') kann mehrere Tage umfassen. WICHTIG: Gib ZUSÄTZLICH für JEDEN Tag ein Feld 'location' an, das den spezifischen Hauptort dieses Tages beschreibt (z.B. 'Agrigent').\n"
        ...
        "  \"stations\": [\n"
        "    {\n"
        "       \"name\": \"Name der Station (z.B. Rundreise Philippinen)\",\n"
        "       \"location\": \"Haupt-Region (z.B. Palawan)\",\n"
        "       \"lat\": 1.23, \"lon\": 45.67,\n"
        "       \"days\": [\n"
        "         {\n"
        "            \"day_number\": 1,\n"
